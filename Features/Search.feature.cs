...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Verify the quick search results display on entering search text")]
        [NUnit.Framework.CategoryAttribute("Search_ValidKeyword")]
        [NUnit.Framework.CategoryAttribute("4733598")]
        public void VerifyTheQuickSearchResultsDisplayOnEnteringSearchText()
        {
            string[] tagsOfScenario = new string[] {
                    "Search_ValidKeyword",
                    "4733598"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify the quick search results display on entering search text", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 9
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Verify the no results notification when there are no results matching the search " +
            "term")]
        [NUnit.Framework.CategoryAttribute("Search_InvalidKeyword")]
        [NUnit.Framework.CategoryAttribute("4733615")]
        public void VerifyTheNoResultsNotificationWhenThereAreNoResultsMatchingTheSearchTerm()
        {
            string[] tagsOfScenario = new string[] {
                    "Search_InvalidKeyword",
                    "4733615"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify the no results notification when there are no results matching the search " +
                    "term", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 15
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
